...
<template>
      ...
      >
        ...
        <p class="font-light text-md text-white/40">
          Available for remote collaborations worldwide
        </p>
        <button
          class="pointer py-2 px-4 flex items-center gap-2 bg-linear-to-r from-primary-500 to-accent-500 mt-5 rounded-md text-shadow-md font-bold"
        >
          Let’s Sync
          <svg
