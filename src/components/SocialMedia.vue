  ...
  >
    ...
    <a href="https://hokya.dev" class="sm:ml-4" @click="onWebsiteClick">
      ...
      >
        ...
        <div class="text-sm text-center font-light"><span>hokya.dev</span></div>
      </div>
    </a>
  </section>
</template>
...
const onEmailClick = () => {
  trackMetric('contact_email_click_total', 1, {
    location: 'social_media_footer',
    channel: 'email',
  })
}

const onWebsiteClick = () => {
  trackMetric('contact_website_click_total', 1, {
    location: 'social_media_footer',
    channel: 'website',
  })
}
